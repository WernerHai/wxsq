//test1
'use strict';
window.AvatarGap=window.AvatarGap==undefined?5:window.AvatarGap;
window.AvatarSize=window.AvatarSize==undefined?5:window.AvatarSize;
var S = {
  ...
  return {
    ...
    imageFile: function (url, callback) {
      ...
      image.onload = function () {
        ...
        shapeContext.drawImage(this, 0, 0, a.w*0.8 , a.h*0.8);
